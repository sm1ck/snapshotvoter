  ...
  const end = () =>
    to.success(
      <span>
        ...
        {toast !== null &&
        toast !== undefined &&
        toast.hasOwnProperty("message") ? (
          <span
            dangerouslySetInnerHTML={{
              __html: DOMPurify.sanitize(toast.message),
            }}
          ></span>
        ) : (
          ""
